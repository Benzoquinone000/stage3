...
python train.py \
  ...
  --device cuda \
  --amp \
  --checkpoint checkpoints/strict/rnnsearch50_wmt14_wordlevel_rtx5090_bs240.pt \
  --metadata checkpoints/strict/rnnsearch50_wmt14_wordlevel_rtx5090_bs240_metadata.json \
  --train-log checkpoints/strict/rnnsearch50_wmt14_wordlevel_rtx5090_bs240_log.jsonl \
  --wandb \
  --wandb-project bahdanau-attention-nmt \
  --wandb-run-name rnnsearch50-wmt14-wordlevel-rtx5090-bs240-20260704 \
  --wandb-watch none
